...
@rx.page(route="/dnr_eol", title="Preferred Medical Care Questions & Answers", image="/github.svg")
@require_login
def dnr_eol() -> rx.Component:
    ...
    return rx.fragment(
        ...
        rx.center(
            rx.vstack(
                rx.heading("Preferred Medical Care Questions & Answers", font_size="0.75em"),
                form,
                spacing="4",
                align="center",
