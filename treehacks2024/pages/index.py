...
def index() -> rx.Component:
    ...
    sidebar = rx.chakra.box(
        rx.chakra.vstack(
            ...
            rx.chakra.box(rx.chakra.link("Medical Resources", href="/medical", display="block", text_align="center", padding="0.5em", border_radius="full", background="#097a87", color="white", font_size="0.5em", width="100%"), width="280px", height="80px", display="flex", justify_content="center", align_items="center"),
